...
: CatalogType(catalog, parent, path, name),
  m_databases(catalog, this, path + "/" + "databases"), m_hosts(catalog, this, path + "/" + "hosts"), m_sites(catalog, this, path + "/" + "sites"), m_partitions(catalog, this, path + "/" + "partitions"), m_deployment(catalog, this, path + "/" + "deployment"), m_faultSnapshots(catalog, this, path + "/" + "faultSnapshots"), m_logconfig(catalog, this, path + "/" + "logconfig")
{
    CatalogValue value;
